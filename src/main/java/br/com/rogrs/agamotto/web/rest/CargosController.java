...
import br.com.rogrs.agamotto.repository.CargosRepository;
...
public class CargosController {
	    ...
	    public CargosController(CargosRepository repository) {
	        this.repository = repository;
	    }

	    @PostMapping("/cargos")
	    public ResponseEntity<Cargos> create(@RequestBody Cargos obj) throws URISyntaxException {
	        ...
	        Cargos result = repository.save(obj);
	    ...
	    @PutMapping("/cargos")
	    public ResponseEntity<Cargos> update(@RequestBody Cargos obj) throws URISyntaxException {
	    ...
	    @GetMapping("/cargos")
	    public ResponseEntity<List<Cargos>> getAll(Pageable pageable) {
	        log.debug("REST request to get a page of {}",ENTITY_NAME);
	        Page<Cargos> page = repository.findAll(pageable);
	        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/cargos");
	        return ResponseEntity.ok().headers(headers).body(page.getContent());
	    }

	    @GetMapping("/cargos/{id}")	    
	    public ResponseEntity<Cargos> get(@PathVariable Long id) {
	        log.debug("REST request to get {}: {}",ENTITY_NAME, id);
	        Optional<Cargos> obj = repository.findById(id);
