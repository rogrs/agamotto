...
export const DepartamentosDetail = (props: IDepartamentosDetailProps) => {
  useEffect(() => {
    props.getEntity(props.match.params.id);
  }, []);

  const { departamentosEntity } = props;
  return (
    <Row>
      <Col md="8">
        <h2>
...
export default connect(mapStateToProps, mapDispatchToProps)(DepartamentosDetail);
