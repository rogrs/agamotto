...
export interface IDepartamentosState {
  search: string;
}

export class Departamentos extends React.Component<IDepartamentosProps, IDepartamentosState> {
  state: IDepartamentosState = {
    search: ''
  };
  ...
  render() {
    const { departamentosList, match } = this.props;
    return (
      <div>
        <h2 id="departamentos-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="agamottoApp.departamentos.home.createLabel">Create a new Departamentos</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
        ...
        <div className="table-responsive">
          {departamentosList && departamentosList.length > 0 ? (
            <Table responsive aria-describedby="departamentos-heading">
              <thead>
                <tr>
                  <th>
