...
export const ColaboradoresDetail = (props: IColaboradoresDetailProps) => {
  useEffect(() => {
    props.getEntity(props.match.params.id);
  }, []);

  const { colaboradoresEntity } = props;
  return (
    <Row>
      <Col md="8">
        <h2>
...
export default connect(mapStateToProps, mapDispatchToProps)(ColaboradoresDetail);
