...
export const LinhasArquivosUpdate = (props: ILinhasArquivosUpdateProps) => {
  const [arquivosId, setArquivosId] = useState('0');
  const [isNew, setIsNew] = useState(!props.match.params || !props.match.params.id);

  const { linhasArquivosEntity, arquivos, loading, updating } = props;
      ...
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : linhasArquivosEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
...
export default connect(mapStateToProps, mapDispatchToProps)(LinhasArquivosUpdate);
