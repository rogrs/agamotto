...
export const FeriadosDetail = (props: IFeriadosDetailProps) => {
  useEffect(() => {
    props.getEntity(props.match.params.id);
  }, []);

  const { feriadosEntity } = props;
  return (
    <Row>
      <Col md="8">
        <h2>
...
export default connect(mapStateToProps, mapDispatchToProps)(FeriadosDetail);
