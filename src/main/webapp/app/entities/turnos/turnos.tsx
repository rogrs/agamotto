...
export class Turnos extends React.Component<ITurnosProps, ITurnosState> {
  state: ITurnosState = {
    search: ''
  };
  ...
  render() {
    const { turnosList, match } = this.props;
    return (
      <div>
        <h2 id="turnos-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="agamottoApp.turnos.home.createLabel">Create a new Turnos</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
        ...
        <div className="table-responsive">
          {turnosList && turnosList.length > 0 ? (
            <Table responsive aria-describedby="turnos-heading">
              <thead>
                <tr>
                  <th>
